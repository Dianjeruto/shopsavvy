...
const contentMap: Record<string, { title: string; intro: string; bullets: string[] }> = {
  'shipping-info': {
    ...
    intro: 'We offer fast, reliable delivery for every order placed on ShopSavvy.',
    bullets: [
      'Standard delivery: 3–5 business days.',
      'Express delivery: 1–2 business days for eligible locations.',
      'Free shipping applies to all orders over KSh 0 in this storefront.',
  ...
  about: {
    ...
    intro: 'Dian is the visionary CEO and manager of ShopSavvy, leading the brand with more than 15 years of experience in business leadership, customer experience, and retail growth.',
    bullets: [
      'Dian has built ShopSavvy around a customer-first approach that blends innovation, trust, and long-term business strategy.',
      'With over 15 years in leadership, Dian guides operations, product direction, and the overall shopping experience for every customer.',
      'Under Dian\'s leadership, ShopSavvy continues to grow as a modern, reliable online destination for fashion, electronics, home, and lifestyle essentials.',
    ],
  },
  careers: {
    title: 'Careers',
  ...
  terms: {
    ...
    intro: 'These terms govern your use of the ShopSavvy storefront and services.',
    bullets: [
      'You agree to use the site for lawful purposes only.',
      'Prices, promotions, and inventory may change without notice.',
      'All content on the site is owned by ShopSavvy or our partners.',
    ],
  },
};
